...
internal const mixin NodeToken {
...
internal const class RootToken : MustacheToken, NodeToken {
...
internal const class ChangeDelimiterToken : MustacheToken {
  const Str otag
  const Str ctag
...
internal enum class TextState { t, r, rn, n }
...
internal const class SectionToken : MustacheToken, NodeToken {
  const MustacheToken[] children
  const Str key
